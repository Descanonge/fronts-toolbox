...
from fronts_toolbox.benchmarks.fields import add_spikes, ideal_jet, swap_noise
...
def plot(components: tuple, title: str) -> plt.Figure:
    ...
    axes_top[0].imshow(sst, cmap="inferno", vmin=vmin, vmax=vmax, **im_kw)
...
plot(components, "Idea jet with noise")
